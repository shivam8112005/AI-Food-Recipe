...
return (
    ...
    <section className='home'>
        <div className="left">
            <h1>Food Recipe</h1>
            <h5>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus voluptatum sed esse et dicta magnam ullam ratione ipsa reiciendis? Ea hic qui dignissimos alias explicabo illum, illo eius minima pariatur!</h5>
            <button>Share your recipe</button>
        </div>
        <div className="right">
            <img src={foodRecipe} alt="Food Recipe" width="320px"height="300px" style={{zIndex:999}}/>
        </div>
